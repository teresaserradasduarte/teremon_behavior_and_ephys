...
right_clr = behavior.colors.right_clr;
center_clr = behavior.colors.center_clr;
left_clr = behavior.colors.left_clr;
...
set(gcf,'position',[2835 607 342 292],'color','w');

 saveas(gcf,fullfile(save_out,['cellType_neu',num2str(eg_neurons(un).phyID),'.png']),'png');
